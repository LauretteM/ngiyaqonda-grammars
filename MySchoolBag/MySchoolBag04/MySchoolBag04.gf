abstract MySchoolBag04 = {
    ...
    fun
        ...
        DrawingUseObjectPoss : Actor -> DrawingInstrument -> UseableObject ;
        ColouringUseObjectPoss : Actor -> ColouringInstrument -> UseableObject ;
        PaintingUseObjectPoss : Actor -> PaintingInstrument -> UseableObject ;
        CuttingUseObjectPoss : Actor -> CuttingInstrument -> UseableObject ;
