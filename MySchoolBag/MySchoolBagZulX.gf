incomplete concrete MySchoolBagZulX of MySchoolBag = open SyntaxSBantuZul,MySchoolBagLexZul,Prelude in {
    ...
    lin
        ...
        ColourS actor = mkS (mkCl (mkNP actor) (mkVP put_V2 (mkNP colour_N))) ;
        ...
        ColourWith actor instr = mkS (mkCl (mkNP actor) (mkVP (mkVP put_V2 (mkNP colour_N)) (instrumentalAdv (mkNP instr)))) ;
        ...
        ColourWithPoss actor instr = mkS (mkCl (mkNP actor) (mkVP (mkVP put_V2 (mkNP colour_N)) (instrumentalAdv (mkNP actor instr)))) ;
        ...
        SchoolBag = mkCN bag_N (mkNP school_N) ;
        Book = mkCN book_N ;
        LunchBox = mkCN container_N (mkNP (mkVP hold_V2 (mkNP food_N))) ;
        ...
        Paintbrush = mkCN brush_N (mkNP (mkVP paint_V)) ;
