abstract MySchoolBag01 = {
    ...
    fun
        ...
        -- DrawingUseObject : Actor -> DrawingInstrument -> UseableObject ;
        -- ColouringUseObject : Actor -> ColouringInstrument -> UseableObject ;
        -- PaintingUseObject : Actor -> PaintingInstrument -> UseableObject ;
        -- CuttingUseObject : Actor -> CuttingInstrument -> UseableObject ;
